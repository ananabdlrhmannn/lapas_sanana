...
@section('title', 'Beranda | Lapas Sanana')
    ...
    <div class="container">
        <div class="row gy-4 align-items-center">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img text-center" data-aos="zoom-out" data-aos-delay="200">
                <img src="{{ asset('arsha/assets/img/foto_kantor.jpeg') }}" class="img-fluid animated rounded-4 shadow-lg" alt="Gedung Lapas Sanana">
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="mini-info image-card p-0 overflow-hidden">
                                <img src="{{ asset('arsha/assets/img/services/sdf.jpeg') }}" alt="Layanan publik Lapas Sanana" class="img-fluid w-100">
                                <div class="p-4">
    ...
    <div class="container-fluid">
        <div class="row gy-4 align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-2 why-us-img text-center">
                <img src="{{ asset('arsha/assets/img/why-us.png') }}" class="img-fluid" alt="Ilustrasi alur pelayanan" data-aos="zoom-in" data-aos-delay="100">
            </div>
        </div>
    </div>
</section>
    ...
    @forelse($galleries as $item)
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-{{ $item->category }}">
            <div class="portfolio-content h-100">
                <img src="{{ asset('storage/' . $item->image) }}" class="img-fluid publikasi-thumb" alt="{{ $item->title }}">
...
<section id="berita" class="section light-background">
    <div class="container section-title d-lg-flex justify-content-between align-items-end" data-aos="fade-up">
        ...
        <div class="mt-3 mt-lg-0">
            <a href="{{ route('news.index') }}" class="btn btn-primary rounded-pill px-4">Lihat Semua Berita</a>
        </div>
    </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
            @forelse($news as $item)
                <div class="col-lg-4 col-md-6 news-item" data-search="{{ strtolower($item->title . ' ' . ($item->category ?? '') . ' ' . ($item->excerpt ?? '')) }}">
                   <article class="news-card h-100">
                        <div class="news-thumb">
                            <img src="{{ $item->thumbnail ? asset('storage/' . $item->thumbnail) : asset('arsha/assets/img/blog/blog-post-2.webp') }}" class="img-fluid" alt="{{ $item->title }}">
                        </div>
...
<section id="kunjungan" class="contact section">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
            ...
            <div class="col-lg-7">
                <form action="{{ route('visits.store') }}" method="POST" class="php-email-form">
                    @csrf
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <input type="text" name="visitor_name" class="form-control" placeholder="Nama pengunjung" value="{{ old('visitor_name') }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <input type="email" name="email" class="form-control" placeholder="Email (opsional)" value="{{ old('email') }}">
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="prisoner_name" class="form-control" placeholder="Nama warga binaan" value="{{ old('prisoner_name') }}" required>
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="relationship" class="form-control" placeholder="Hubungan dengan warga binaan" value="{{ old('relationship') }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <select name="session" class="form-control">
                                ...
                                <option value="Pagi" @selected(old('session') === 'Pagi')>Pagi</option>
                                <option value="Siang" @selected(old('session') === 'Siang')>Siang</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                            <textarea name="notes" rows="5" class="form-control" placeholder="Catatan tambahan (opsional)">{{ old('notes') }}</textarea>
                        </div>
        ...
        <div class="row gy-4">
            <div class="col-lg-5">
                <div class="info-wrap h-100">
                    ...
                    <div class="complaint-illustration mt-4">
                        <img src="{{ asset('arsha/assets/img/illustration/illustration-10.webp') }}" class="img-fluid" alt="Ilustrasi pengaduan masyarakat">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7">
                <form action="{{ route('complaints.store') }}" method="POST" class="php-email-form">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <input type="text" name="name" class="form-control" placeholder="Nama pelapor" value="{{ old('name') }}" required>
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="contact" class="form-control" placeholder="Nomor HP / Email" value="{{ old('contact') }}" required>
                        </div>
                        <div class="col-md-12">
                            <select name="category" class="form-control" required>
                                <option value="">Pilih kategori pengaduan</option>
                                <option value="Layanan Publik" @selected(old('category') === 'Layanan Publik')>Layanan Publik</option>
                                <option value="Administrasi" @selected(old('category') === 'Administrasi')>Administrasi</option>
                                <option value="Dugaan Pungli" @selected(old('category') === 'Dugaan Pungli')>Dugaan Pungli</option>
                                <option value="Petugas" @selected(old('category') === 'Petugas')>Petugas</option>
                                <option value="Lainnya" @selected(old('category') === 'Lainnya')>Lainnya</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                            <textarea name="message" rows="6" class="form-control" placeholder="Tulis pengaduan atau masukan Anda" required>{{ old('message') }}</textarea>
                        </div>
                        <div class="col-md-12 text-center">
...
<section id="zi" class="call-to-action section dark-background">
    <img src="{{ asset('arsha/assets/img/bg/bg-8.webp') }}" alt="Latar zona integritas">
    <div class="container">
            ...
            <div class="col-lg-7">
                <div class="contact-panel h-100">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><a class="contact-shortcut" href="{{ route('login') }}"><i class="bi bi-arrow-right-circle"></i> Login admin</a></div>
                    </div>
