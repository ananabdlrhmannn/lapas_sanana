...
<head>
    ...
    <title>@yield('title', 'Dashboard Admin | Lapas Sanana')</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="icon" type="image/png" href="{{ asset('arsha/assets/img/fav.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('arsha/assets/img/fav.png') }}">
...
<div class="container-fluid">
        ...
        <div class="col-xl-2 col-lg-3">
            <aside class="admin-sidebar">
                <a href="{{ route('admin.dashboard') }}" class="admin-brand">
                    <img src="{{ asset('arsha/assets/img/logo imipas.jpg') }}" alt="Logo">
                    <div>
   ...
   <ul class="nav flex-column">
    ...
    @if(auth()->user()->hasPermission('manage_visits'))
        <li class="nav-item">
    ...
    @if(auth()->user()->hasPermission('manage_complaints'))
        <li class="nav-item">
    ...
    @if(auth()->user()->hasPermission('manage_galleries'))
        <li class="nav-item">
    ...
    @endif
                    ...
                    <a class="nav-link" href="{{ route('home') }}" target="_blank"><i class="bi bi-box-arrow-up-right"></i> Lihat Website</a>
            ...
            <main class="admin-main">
                <div class="topbar-card p-4 mb-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    <div>
                        ...
                        <h1 class="page-title h3 mt-3 mb-1">@yield('page_heading', 'Dashboard Admin')</h1>
                ...
                @if(session('success'))
                    <div class="alert alert-success shadow-sm border-0 rounded-4">{{ session('success') }}</div>
                @endif
