<?php $__env->startSection('title', 'Dashboard Admin | Lapas Sanana'); ?>
        ...
        <div class="stat-card p-4 h-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h3 class="mb-0"><?php echo e($newsCount); ?></h3>
                </div>
        ...
        <div class="stat-card p-4 h-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h3 class="mb-0"><?php echo e($visitCount); ?></h3>
                </div>
        ...
        <div class="stat-card p-4 h-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h3 class="mb-0"><?php echo e($complaintCount); ?></h3>
                </div>
        ...
        <div class="stat-card p-4 h-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h3 class="mb-0"><?php echo e($pendingVisits); ?></h3>
                </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="border rounded-4 p-3 h-100">
                        ...
                        <div class="fs-3 fw-bold"><?php echo e($newComplaints); ?></div>
    ...
    <div class="col-lg-5">
        <div class="panel-card p-4 h-100">
            ...
            <div class="d-grid gap-3">
                <a href="<?php echo e(route('admin.news.create')); ?>" class="btn btn-primary btn-lg text-start"><i class="bi bi-plus-circle me-2"></i>Tambah Berita Baru</a>
                <a href="<?php echo e(route('admin.visits.index')); ?>" class="btn btn-outline-primary btn-lg text-start"><i class="bi bi-calendar-event me-2"></i>Kelola Kunjungan</a>
                <a href="<?php echo e(route('admin.complaints.index')); ?>" class="btn btn-outline-primary btn-lg text-start"><i class="bi bi-chat-dots me-2"></i>Tinjau Pengaduan</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CPNS\LATSAR\sistem\lapas-sanana\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>